...
var _user$project$Main$viewCode = A2(
		...
		_0: A2(
			...
			{ctor: '[]'},
			{
				...
				_0: A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html_Attributes$class('code-block'),
						_1: {ctor: '[]'}
					},
					{
						ctor: '::',
						_0: _elm_lang$html$Html$text('type Score\n        = Touchdown\n        | ExtraPoint\n        | FieldGoal\n\n\npoints : Score -> Int\npoints s =\n        case s of\n            Touchdown ->\n                6\n\n            ExtraPoint ->\n                1\n\n            FieldGoal ->\n                3\n\n\nreaction : Score -> String\nreaction =\n        always \"OH YEAH!\"\n                '),
						_1: {ctor: '[]'}
					}),
				_1: {ctor: '[]'}
			}),
	...
	return A2(
		...
		_elm_lang$core$List$singleton(
			_elm_lang$html$Html$text(
				_user$project$Main$reaction(score))));
};
var _user$project$Main$points = function (s) {
	var _p0 = s;
	switch (_p0.ctor) {
		case 'Touchdown':
			return 6;
...
var _user$project$Main$scoreItem = function (score) {
	return A2(
		_elm_lang$html$Html$td,
		{ctor: '[]'},
		_elm_lang$core$List$singleton(
			_elm_lang$html$Html$text(
				_elm_lang$core$Basics$toString(
					_user$project$Main$points(score)))));
};
var _user$project$Main$row = function (score) {
	return A2(
		_elm_lang$html$Html$tr,
		{ctor: '[]'},
		{
			ctor: '::',
			_0: _user$project$Main$scoreItem(score),
			_1: {
				ctor: '::',
				_0: _user$project$Main$reactionItem(score),
				_1: {ctor: '[]'}
			}
		});
};
...
var _user$project$Main$ExtraPoint = {ctor: 'ExtraPoint'};
var _user$project$Main$Touchdown = {ctor: 'Touchdown'};
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{
							scores: A2(
								...
								{
									ctor: '::',
									_0: _user$project$Main$Touchdown,
									_1: {ctor: '[]'}
								})
						}),
					_1: _elm_lang$core$Platform_Cmd$none
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{
							scores: A2(
								...
								{
									ctor: '::',
									_0: _user$project$Main$ExtraPoint,
									_1: {ctor: '[]'}
								})
						}),
					_1: _elm_lang$core$Platform_Cmd$none
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{
							scores: A2(
								...
								{
									ctor: '::',
									_0: _user$project$Main$FieldGoal,
									_1: {ctor: '[]'}
								})
						}),
					_1: _elm_lang$core$Platform_Cmd$none
...
var _user$project$Main$AddFieldGoal = {ctor: 'AddFieldGoal'};
